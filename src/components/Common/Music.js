...
export default function() {
	...
	function switchState() {
		if (musicState === Sound.status.PAUSED) {
			//Does not trigger when I pause/play the music using my headset buttons
	...
	return (
		<div style={styles.container} onClick={() => switchState()}>
			{iconState}
			<Sound url={bgMusic} playStatus={musicState} loop={true} />
		</div>
	);
}
